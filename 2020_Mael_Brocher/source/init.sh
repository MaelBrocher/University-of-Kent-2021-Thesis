...
/usr/bin/python3 -m pip install --upgrade pip; #upgrade it just in case
/usr/bin/python3 -m pip install pip setuptools wheel spacy fasttext; #install needed package
